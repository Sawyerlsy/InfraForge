...
min-replicas-to-write 1           # 防脑裂：至少1个从节点同步才允许写入
...
# 192.168.1.102:7005 和 192.168.1.103:7008 → 作为192.168.1.101:7001的从节点
# 192.168.1.101:7002 和 192.168.1.103:7009 → 作为192.168.1.102:7004的从节点
# 192.168.1.101:7003 和 192.168.1.102:7006 → 作为192.168.1.103:7007的从节点
```
